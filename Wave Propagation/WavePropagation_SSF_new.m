function [A, P] = WavePropagation_SSF_new(Undepleted, Lambda, w0, NumOfPoints, PlaneGauss_, dx_prop, CrystalPropAxis, DeltaK, K, Omega, n, I, InteractionType, deff, A_from_I, Kappa, P_from_A, samples)
...
toc
figure; 
plot(unwrap(Ain1Phase));
hold on;
plot(unwrap(AoutPhase));
plot(unwrap(AoutPhase-Ain1Phase));
