function [A, P] = WavePropagation_SSF0(Undepleted, Lambda, w0, NumOfPoints, PlaneGauss_, dx_prop, CrystalPropAxis, DeltaK, K, Omega, n, I, InteractionType, deff, A_from_I, Kappa, P_from_A, samples)
...
%                 chi.out        = chi_(b.out);
                ...
                Aout   = zeros(samples,1); % A_from_I(I.out,n.out(1))/(1+1i*chi.out)*exp(-(r_.^2)/(w0.out^2*(1+1i*chi.out)));
