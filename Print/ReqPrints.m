...
GradTypeVec             = {'Const','Linear', 'ApodizationMain', 'ApodizationMain_Exp', 'Exp_5x5x50','Exp_4x4x50', 'Exp_3x3x30', 'ArcTan', 'Apodization3','Apodization1','Apodization2','Apodization3_Old' ,'Apodization1.5','Apodization1.6','Apodization3.5','Exponential'};
GradType                = char(GradTypeVec(2));
