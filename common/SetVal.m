...
w0.I        = 30e-6;% 120e-6; %49e-6/sqrt(2); % B&K for xi=2.84 -> w0.I=43.170e-06/sqrt(2)
...
switch InteractionType
    ...
    if strcmp(Type,'non critical')
        ...
        PinPeak     = 200;%PinAvg/(f*Pulse_wdt);
