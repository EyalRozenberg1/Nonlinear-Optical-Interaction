...
TempVec   = linspace(T.pm-1,T.pm+1,TempSamples);
...
% close(h);
% Print results
[figNum] = PrintResults(PinPeak, PlaneGauss_, figNum, 0, 0, Efficiency, Lambda, TempVec, 0, P2w, 0, I, 0, InteractionType, Print, NumOfPoints, 0, 0, 0, 0);
