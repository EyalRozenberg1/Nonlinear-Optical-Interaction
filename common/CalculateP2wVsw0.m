...
%     waitbar(beamwidth / w0Samples);
    ...
    [A, P] = WavePropagation_SSF(Undepleted, Lambda, w_0, NumOfPoints, PlaneGauss_, dx_prop, CrystalPropAxis, DeltaK, K, Omega, n, I, InteractionType, deff, A_from_I, Kappa, P_from_A, samples,0);
